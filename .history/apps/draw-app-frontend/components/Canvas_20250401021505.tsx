...
function Topbar({selectedTool,setSelectedTool} : {selectedTool : Shape, setSelectedTool: (s : Shape) => void }){
    return <div style={{
        ...
        <IconButton activated= {selectedTool == "pencil"} icon={<Pencil/>} onClick={() => {}}></IconButton>
        <IconButton activated= {selectedTool == "pencil"} icon={<RectangleHorizontalIcon/>} onClick={() => {}}></IconButton>
        <IconButton activated= {selectedTool == "pencil"} icon={<Circle/>} onClick={() => {}}></IconButton>
        </div>
